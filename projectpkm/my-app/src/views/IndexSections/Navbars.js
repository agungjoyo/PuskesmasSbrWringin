      ...
      <section>
        ...
        <Navbar className="navbar-dark bg-default" expand="lg">
          <Container>
            ...
            <button type="button" className="navbar-toggler" id="navbar-default">
        ...
        <Navbar className="navbar-dark bg-primary mt-4" expand="lg">
          <Container>
            ...
            <button type="button" className="navbar-toggler" id="navbar-primary">
              <span className="navbar-toggler-icon" />
            </button>
        ...
        <Navbar className="navbar-dark bg-success mt-4" expand="lg">
          <Container>
            ...
            <button type="button" className="navbar-toggler" id="navbar-success">
              <span className="navbar-toggler-icon" />
            </button>
        ...
        <Navbar className="navbar-dark bg-danger mt-4" expand="lg">
          <Container>
            ...
            <button type="button" className="navbar-toggler" id="navbar-danger">
              <span className="navbar-toggler-icon" />
            </button>
        ...
        <Navbar className="navbar-dark bg-warning mt-4" expand="lg">
          <Container>
            ...
            <button type="button" className="navbar-toggler" id="navbar-warning">
              <span className="navbar-toggler-icon" />
            </button>
        ...
        <Navbar className="navbar-dark bg-info mt-4" expand="lg">
          <Container>
            ...
            <button type="button" className="navbar-toggler" id="navbar-info">
              <span className="navbar-toggler-icon" />
            </button>
