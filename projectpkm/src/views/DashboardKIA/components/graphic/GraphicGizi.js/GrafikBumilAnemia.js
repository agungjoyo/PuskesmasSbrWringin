...
class GrafikBumilAnemia extends Component {
  state = {
    monthIndex: [],
    quarterIndex: [],
                        ...
                        for (let i = 0; i < dataFinal[i].set.length; i++) {
                          for (
                            ...
                            if (
                              ...
                              JmlIHHBBulan = dataFinal[a].set[i].JmlIHHB;
                              JmlIHANBulan =
                                JmlIHANBulan + dataFinal[a].set[i].JmlIHAN;
                            }
                          }
                        }
                        series1.push(JmlIHHBBulan);
                        series2.push(JmlIHANBulan);
                      }
                    }
                  }
          ...
          if (dataFinal[a].Puskesmas == desa[a]) {
            for (let i = 0; i < dataFinal[i].set.length; i++) {
              if (
                ...
                JmlIHHBYear = JmlIHHBYear + dataFinal[a].set[i].JmlIHHB;
                JmlIHANYear = JmlIHANYear + dataFinal[a].set[i].JmlIHAN;
              }
            }
            series1.push(JmlIHHBYear);
            series2.push(JmlIHANYear);
            category.push(dataFinal[a].Puskesmas);
          }
        }
        for (let s1 = 0; s1 < series1.length; s1++) {
