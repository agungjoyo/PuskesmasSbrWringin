...
class GrafikBagikur extends Component {
  state = {
    monthIndex: [],
    quarterIndex: [],
                        ...
                        for (let i = 0; i < dataFinal[i].set.length; i++) {
                          for (
                            ...
                            if (
                              ...
                              JmlBLTGKBulan = dataFinal[a].set[i].JmlBLTGK;
                              JmlPMTGKBulan =
                                JmlPMTGKBulan + dataFinal[a].set[i].JmlPMTGK;
                            }
                          }
                        }
                        series1.push(JmlBLTGKBulan);
                        series2.push(JmlPMTGKBulan);
                      }
                    }
                  }
          ...
          if (dataFinal[a].Puskesmas == desa[a]) {
            for (let i = 0; i < dataFinal[i].set.length; i++) {
              if (
                ...
                JmlBLTGKYear = JmlBLTGKYear + dataFinal[a].set[i].JmlBLTGK;
                JmlPMTGKYear = JmlPMTGKYear + dataFinal[a].set[i].JmlPMTGK;
              }
            }
            series1.push(JmlBLTGKYear);
            series2.push(JmlPMTGKYear);
            category.push(dataFinal[a].Puskesmas);
          }
        }
        for (let s1 = 0; s1 < series1.length; s1++) {
