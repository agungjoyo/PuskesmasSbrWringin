                        ...
                        for (let i = 0; i < dataFinal[i].set.length; i++) {
                          for (
                            ...
                            if (
                              ...
                              JmlGiburBulan =
                                JmlGiburBulan + dataFinal[a].set[i].JmlGibur;
                              JmlGirangBulan =
                                JmlGirangBulan + dataFinal[a].set[i].JmlGirang;
                              JmlNMLBulan =
                                JmlNMLBulan + dataFinal[a].set[i].JmlNML;
                              JmlRGzLbhBulan =
                                JmlRGzLbhBulan + dataFinal[a].set[i].JmlRGzLbh;
                              JmlGzLbhBulan =
                                JmlGzLbhBulan + dataFinal[a].set[i].JmlGzLbh;
                              JmlObesBulan =
                                JmlObesBulan + dataFinal[a].set[i].JmlObes;
                            }
                          }
                        }
