// Bayi Paripurna, vit a1, imunisasi dasar lengkap
...
class GraphicCocBayiPur extends Component {
  state = {
    monthIndex: [],
    quarterIndex: [],
                      ...
                      for (let b = 0; b < dataKIA.length; b++) {
                        for (let e = 0; e < dataKIA[b].set.length; e++) {
                          if (
                            ...
                            BayiParipurna =
                              BayiParipurna +
                              dataKIA[b].set[e].KunjunganBayiParipurnaTL;
                          }
                        }
                      ...
                      for (let d = 0; d < dataImunisasi.length; d++) {
                        for (let g = 0; g < dataImunisasi[d].set.length; g++) {
                          if (
                            ...
                            Idl = Idl + dataImunisasi[d].set[g].IDLThisMonth;
                          }
                        }
                      }
                    }
                    series1.push(BayiParipurna);
                    series2.push(VitA);
                    series3.push(Idl);
  ...
  render() {
    ...
    if (auth.isLoaded == false) {
      ...
      return (
        <RootStyle>
          <CardHeader
            title="COC Bayi Paripurna, Vitamin A1, Imunisasi Dasar Lengkap"
