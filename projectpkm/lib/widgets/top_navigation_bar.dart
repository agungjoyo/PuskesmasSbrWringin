...
import 'package:projectpkm/constants/style.dart';
...
AppBar topNavigationBar(BuildContext context, GlobalKey<ScaffoldState> key) =>
  AppBar(
        leading: !ResponsivenessWidgets.isSmallScreen(context) ? 
        Row(
          children: [
            Container(
        ...
        title: Row(
          children: [
            Visibility(child: CustomText(text: "Home", color: lightGrey, weight: FontWeight.bold)),
            Expanded(child: Container()),
            IconButton
              (icon: Icon(Icons.settings, color: dark.withOpacity(0.7)), onPressed: (){},),
            Stack(
              children: [
                IconButton(
